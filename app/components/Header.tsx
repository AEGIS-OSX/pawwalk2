...
export default function Header() {
  ...
  return (
    ...
    >
      <nav
        className="flex items-center justify-between px-[var(--space-md)] py-[var(--space-md)] max-w-full md:px-[var(--space-lg)]"
      ...
      >
        ...
        <div className="flex items-center">
          <a
            href="#hero"
            className="text-[20px] leading-[28px] font-[600] font-[var(--font-display)] text-[var(--color-text-primary)] focus-visible:outline focus-visible:outline-[3px] focus-visible:outline-[var(--color-brand-accent)] focus-visible:outline-offset-[2px] rounded-[4px] px-[4px]"
